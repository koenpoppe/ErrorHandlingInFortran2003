...
!   20111114 (KP) - Re-generated (make autogenerated)
! 
! AUTHOR
! 
...
module error_handling_unit_test
    ...
    interface assert_lt
        ...
        module procedure assert_lt_real_rank0
        module procedure assert_lt_real_rank1
        module procedure assert_lt_real_rank2
        module procedure assert_lt_real_double_rank0
        module procedure assert_lt_real_double_rank1
        module procedure assert_lt_real_double_rank2
    ...
    interface assert_le
        ...
        module procedure assert_le_real_rank0
        module procedure assert_le_real_rank1
        module procedure assert_le_real_rank2
        module procedure assert_le_real_double_rank0
        module procedure assert_le_real_double_rank1
        module procedure assert_le_real_double_rank2
    ...
    interface assert_gt
        ...
        module procedure assert_gt_real_rank0
        module procedure assert_gt_real_rank1
        module procedure assert_gt_real_rank2
        module procedure assert_gt_real_double_rank0
        module procedure assert_gt_real_double_rank1
        module procedure assert_gt_real_double_rank2
    ...
    interface assert_ge
        ...
        module procedure assert_ge_real_rank0
        module procedure assert_ge_real_rank1
        module procedure assert_ge_real_rank2
        module procedure assert_ge_real_double_rank0
        module procedure assert_ge_real_double_rank1
        module procedure assert_ge_real_double_rank2
...
contains
    ...
    recursive subroutine assert_eq_integer_rank0( a, b, &
        ...
        if( a == b ) then
            ...
            ! Export the data as character string
            lfmt = "("//optional_character(fmt,"I8")//")"
            lfmt_width = fmt_width( lfmt )
            allocate(a_str,source=repeat(" ",lfmt_width))
            allocate(b_str,source=repeat(" ",lfmt_width))
    ...
    recursive subroutine assert_lt_real_rank0( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real, intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
        ...
        if( a < b ) then
            ...
            ! Export the data as character string
            lfmt = "("//optional_character(fmt,"ES13.5")//")"
            lfmt_width = fmt_width( lfmt )
            allocate(a_str,source=repeat(" ",lfmt_width))
            allocate(b_str,source=repeat(" ",lfmt_width))
    ...
    end subroutine assert_lt_real_rank0
    recursive subroutine assert_lt_real_rank1( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
    ...
    end subroutine assert_lt_real_rank1
    recursive subroutine assert_lt_real_rank2( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real, dimension(:,:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_lt_real_rank2
    recursive subroutine assert_lt_real_double_rank0( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        ...
        if( a < b ) then
            ...
            ! Export the data as character string
            lfmt = "("//optional_character(fmt,"ES23.16")//")"
            lfmt_width = fmt_width( lfmt )
            allocate(a_str,source=repeat(" ",lfmt_width))
            allocate(b_str,source=repeat(" ",lfmt_width))
    ...
    end subroutine assert_lt_real_double_rank0
    recursive subroutine assert_lt_real_double_rank1( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
    ...
    end subroutine assert_lt_real_double_rank1
    recursive subroutine assert_lt_real_double_rank2( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real(kind=kind(1.0d0)), dimension(:,:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_lt_real_double_rank2
    ...
    recursive subroutine assert_le_real_rank0( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real, intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_le_real_rank0
    recursive subroutine assert_le_real_rank1( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real, dimension(:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_le_real_rank1
    recursive subroutine assert_le_real_rank2( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real, dimension(:,:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_le_real_rank2
    recursive subroutine assert_le_real_double_rank0( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real(kind=kind(1.0d0)), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_le_real_double_rank0
    recursive subroutine assert_le_real_double_rank1( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real(kind=kind(1.0d0)), dimension(:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_le_real_double_rank1
    recursive subroutine assert_le_real_double_rank2( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real(kind=kind(1.0d0)), dimension(:,:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_le_real_double_rank2
    ...
    recursive subroutine assert_gt_real_rank0( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real, intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_gt_real_rank0
    recursive subroutine assert_gt_real_rank1( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real, dimension(:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_gt_real_rank1
    recursive subroutine assert_gt_real_rank2( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real, dimension(:,:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_gt_real_rank2
    recursive subroutine assert_gt_real_double_rank0( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real(kind=kind(1.0d0)), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_gt_real_double_rank0
    recursive subroutine assert_gt_real_double_rank1( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real(kind=kind(1.0d0)), dimension(:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_gt_real_double_rank1
    recursive subroutine assert_gt_real_double_rank2( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real(kind=kind(1.0d0)), dimension(:,:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_gt_real_double_rank2
    ...
    recursive subroutine assert_ge_real_rank0( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real, intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_ge_real_rank0
    recursive subroutine assert_ge_real_rank1( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real, dimension(:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_ge_real_rank1
    recursive subroutine assert_ge_real_rank2( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real, dimension(:,:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_ge_real_rank2
    recursive subroutine assert_ge_real_double_rank0( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real(kind=kind(1.0d0)), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_ge_real_double_rank0
    recursive subroutine assert_ge_real_double_rank1( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real(kind=kind(1.0d0)), dimension(:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_ge_real_double_rank1
    recursive subroutine assert_ge_real_double_rank2( a, b, &
                            comment, ifail, statement,a_name,b_name,filename,line,fmt )
        real(kind=kind(1.0d0)), dimension(:,:), intent(in) :: a,b
        character(len=*), intent(in), optional :: a_name,b_name,filename,comment, statement, fmt
        integer, intent(in), optional :: line
    ...
    end subroutine assert_ge_real_double_rank2
